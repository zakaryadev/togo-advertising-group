  ...
  return (
    <header>
      <div className="wrap bar">
        <Link href="#home" className="logo-link" aria-label="TOGO GROUP ADVERTISING">
          <svg
            className="logo"
            role="img"
        ...
        <nav className="menu">
          ...
          <Link href="#narx">Narxlar</Link>
          <Link href="#tadbir">Tadbirlar</Link>
          <Link href="#rasmiy">Kompaniya</Link>
          <Link href="#anketa">Buyurtma</Link>
        </nav>
      ...
      {navOpen && (
        <div className="drawer" style={{ display: "block" }}>
          ...
          <Link href="#yonalish" onClick={() => setNavOpen(false)}>
            Yo'nalishlar
          </Link>
          <Link href="#portfolio" onClick={() => setNavOpen(false)}>
            Portfolio
          </Link>
          <Link href="#narx" onClick={() => setNavOpen(false)}>
            Narxlar
          </Link>
          <Link href="#tadbir" onClick={() => setNavOpen(false)}>
            Tadbirlar
          </Link>
          <Link href="#rasmiy" onClick={() => setNavOpen(false)}>
            Kompaniya
          </Link>
          <Link href="#anketa" onClick={() => setNavOpen(false)}>
            Buyurtma
          </Link>
        </div>
      )}
