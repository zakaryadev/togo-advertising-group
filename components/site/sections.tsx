...
const pageText = {
  ...
  events: { title: { uz: "Ko‘rgazma va tadbirlarni to‘liq bezaymiz", ru: "Полностью оформляем выставки и мероприятия", en: "Complete exhibition and event production" }, lead: { uz: "CAEx Expo Centre va boshqa maydonlardagi ko‘rgazmalar, MDH davlatlaridagi forum va tadbirlar — brif olishdan tadbir tugagach demontajgacha. Bitta jamoa, bitta shartnoma, bitta javobgar.", ru: "Выставки в CAEx Expo Centre и на других площадках, форумы и мероприятия в странах СНГ — от брифа до демонтажа. Одна команда, один договор, один ответственный.", en: "Exhibitions at CAEx Expo Centre and other venues, forums and events across the CIS — from brief to dismantling, with one team and one contract." } },
