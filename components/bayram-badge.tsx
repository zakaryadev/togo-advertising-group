...
export const holidaySchedule: Holiday[] = [
  ...
  { id: "independence", from: "08-28", to: "09-03", accent: "#0099B5", icon: "★", date: { uz: "1-sentabr", ru: "1 сентября", en: "1 September" }, name: { uz: "Mustaqillik kuni", ru: "День независимости", en: "Independence Day" }, message: { uz: "Ozod va obod yurt bayrami muborak!", ru: "С праздником свободной страны!", en: "Celebrating a free and proud nation!" } },
